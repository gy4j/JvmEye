...
public class Log4j2Helper {
    ...
    static {
        try {
            Class<?> loggerContentClass = Log4j2Helper.class.getClassLoader().loadClass("org.apache.logging.log4j.core.LoggerContext");
            ...
            if ((loggerClass.getClassLoader().equals(Log4j2Helper.class.getClassLoader())
                    && loggerContentClass.getClassLoader().equals(Log4j2Helper.class.getClassLoader()))
                    || (Log4j2Helper.class.getClassLoader().getParent() != null
                    && loggerClass.getClassLoader().equals(Log4j2Helper.class.getClassLoader().getParent())
                    && loggerContentClass.getClassLoader().equals(Log4j2Helper.class.getClassLoader().getParent())
                    && Log4j2Helper.class.getClassLoader().getClass().getName().indexOf("RestartClassLoader") != -1)) {
                Log4j2 = true;
            }
    ...
    public static Map<String, Map<String, Object>> getLoggers(String name) {
        ...
        if (name != null && !name.trim().isEmpty()) {
            ...
            if (!name.equalsIgnoreCase(LoggerConfig.ROOT) && StringUtils.isBlank(loggerConfig.getName())) {
                return loggerInfoMap;
            }
