    ...
    static {
        try {
            ...
            if (loggerClass.getClassLoader().equals(LogbackHelper.class.getClassLoader())
                    || (LogbackHelper.class.getClassLoader().getParent() != null
                    && loggerClass.getClassLoader().equals(LogbackHelper.class.getClassLoader().getParent())
                    && LogbackHelper.class.getClassLoader().getClass().getName().indexOf("RestartClassLoader") != -1)) {
